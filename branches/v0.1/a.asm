...
;h; <p>This is the "manual" of the multi platform VI65 0.1 editor.</p>
...
;t; <p>VI65 0.1 (C) 2010 Soci/Singular &lt;soci at server c64.rulez.org&gt;</p>
;t; </body></html>
...
nolinetxt	.char nolinetxte-nolinetxt-1
		.text "-- empty --"
nolinetxte
...
banner		.char bannere-banner-1
		.text "vi65 0.1 soci/singular"
bannere
...
noline		lda marks.column+marks.end
		cmp column
		bge +
		ldx column
		sta column
...
emptybuf	.proc
		...
		lda allocline+1
		sta cursorline+1
		sta registers.first+1+registers.file
		sta registers.last+1+registers.file
		ldy #0
		sty lines+1
		lda #<(registers+registers.file)
		sta (allocline),y
		ldy #2
		sta (allocline),y
		iny
...
nomemtxt	.char nomemtxte-nomemtxt-1
		.text "-- nomem --"
nomemtxte
