...
a: a.asm insert.asm ex.asm motion.asm scroll.asm displaytxt.asm displaygfx64.asm displaygfx80.asm displayvdc.asm displaygfx53.asm io.asm Makefile doc.txt \
	...
	$(TASS) -a -b -B -C a.asm -o a -La.dasm -DTARGET=64 -DGFX=0
	x64 a
	#atari800.x11 a
...
doc.html doc.txt doc.seq doc.atx DOC.TXT: a.asm motion.asm scroll.asm insert.asm ex.asm
...
all: a.asm insert.asm ex.asm motion.asm scroll.asm displaytxt.asm displaygfx64.asm displaygfx80.asm displayvdc.asm displaygfx53.asm io.asm doc.txt \
	petscii6x8.fnt atascii6x8.fnt a2ascii6x8.fnt \
	petscii5x8.fnt atascii5x8.fnt a2ascii5x8.fnt \
	petscii4x8.fnt atascii4x8.fnt
